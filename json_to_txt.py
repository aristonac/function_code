...
src_file = Path("C:/WORK_DATA/Annotation/haare/1400_ROI/Haare_Master_1400_rek1.json")
...
for image_obj in src_dict["images"]:
  ...
  for scene_obj in image_obj["scenes"]:
    for label_obj in scene_obj["labelItems"]:
      ...
      res.append(f"{label} {(((x1-x0)/2)+x0)/4096} {(((y1-y0)/2)+y0)/1400} {(x1-x0)/4096} {(y1-y0)/1400}\n")
