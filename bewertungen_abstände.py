...
#         print(data)
        ...
        median = statistics.median(data_result[:len(df['x'])])
        mean = statistics.mean(data_result[:len(df['x'])])
        ...
        #all_med = statistics.median(median)
        #all_mean = statistics.mean(mean)
        
        # print(all_med)
        # print(all_mean)
        
        print('The median is ',statistics.median(data_result[:len(df['x'])]))
        print('The mean is ',statistics.mean(data_result[:len(df['x'])]))

get_statistic(r'C:/Users/ML/venv_yolov5/yolov5/runs/detect_cp/cp19/labels/')
